...
function listChildren(params) {
  ...
  if (params.query && !isQueryStringUrlEncoded(params.query)) {
    console.warning("Query string (" + params.query + ") doesn't look url encoded. You should url encode query string");
  }

  var options = {
    method: "GET",
    uri: appConfig.apiUrl + userPath + "items/" + params.itemId + "/children" + params.query,
    headers: {
